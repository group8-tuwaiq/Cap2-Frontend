...
<Button className="anim" style={{margin: "13px"}} variant="danger">More</Button>
 <Button className="anim" variant='light'>  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-heart-fill" viewBox="0 0 16 16">
...
<Card className="anim" style={{ color:"red"},{margin: "13px"}}>
<Card.Img className="anim" variant="top" src="https://i.imgflip.com/1yj1os.gif" height="350" width="250" alt="no image"  />
<Card.Body>
<Card.Title  style={{color:"red"}}>Movies Name</Card.Title>
<Card.Text  style={{color:"red"}}>
 Movies Description
</Card.Text>
<Button className="anim" variant="danger">More</Button>
 <Button className="anim" variant='light'>  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-heart-fill" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
</svg> </Button>
</Card.Body>
